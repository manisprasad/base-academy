...
export const UploadCourse = () => {
        ...
        setIsEditMode(true);
            ...
            axiosInstance.get(`/api/courses/${courseId}`)
                .then(response => {
                    ...
                    setValue("isFree", courseData.isFree || false);
                    ...
                    setValue("prerequisites", courseData.prerequisites || []);
                    setValue("faq", courseData.faq || []);
                    setValue("courseLink", courseData.courseLink || []);
                })
                .catch(error => {
                    toast.error("Failed to fetch course data for editing", error);
                });
        }
    }, [courseId ]);
            ...
            faq: [
                {
                    ...
                    answer: "Yes, it aligns with both CBSE and ICSE Class 10 syllabus"
                },
                {
    ...
    const onSubmit = async (data: z.infer<typeof formSchema>) => {
        ...
        try {
            ...
            let d ;
           if(!isEditMode){
              d = await axiosInstance.post('/api/courses', data);
           }else{
              d = await axiosInstance.put(`/api/courses/${courseId}`, data);
           }
            toast.success("yo ho!", {
    ...
    return (
        <div className="container mx-auto py-8 px-4 mt-22">
